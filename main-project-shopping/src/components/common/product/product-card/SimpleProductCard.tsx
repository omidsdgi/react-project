...
export function SimpleProductCard({data}: Props) {
    return (
        <div
            ...
            <Badge badge={data.lable} price={data.price} sale_price={data.sale_price} />
            <div
            ...
            <ImageView src={data.image} alt={'product'} height={168} width={210} className={'m-auto w-full aspect-[3/2] mb-[28px]'}/>
